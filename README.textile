...
h2. What does this fork do?

This fork is for using Morning Glory on Heroku. It looks for your S3 configuration in your Heroku environment before checking the plugin's config file.
